...
function RegisterPanel() {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-gradient-to-r from-red-300 to-red-400">
      <Formik
      ...
      >
        <div className="w-1/2 h-1/2 bg-gray-200 rounded-lg shadow-lg">
          ...
          <Form className="flex flex-col justify-center items-center mt-4">
            ...
            <Field
              className=" w-1/2 h-10 border-2 border-gray-300 rounded-lg px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-red-500"
              name="id"
              type="text"
            />
